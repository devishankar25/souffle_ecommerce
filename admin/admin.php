...
<head>
    ...
    <title>Souffle Admin Login</title>
                ...
                <div class="popup">
                    <form action="admin.php" method="post">
                        ...
                        <div class="inputbox">
                            ...
                            <input type="email" name="email" onkeydown="return /[a-zA-Z0-9@.]/i.test(event.key)"
                        ...
                        <div class="forget">
                            <label><input type="checkbox">Remember Me <a href="#">Forgot
                                    Password</a></label>
                        </div>
                        ...
                        <div class="admin_no text-danger bg-light">
                            <a href="main_page.php" class="admin text-danger">I am a
                                User</a>
                        </div>
                    </form>
                </div>

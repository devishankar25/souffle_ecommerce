<?php
// filepath: c:\xampp\htdocs\souffle_ecommerce\user\profile.php
include('../includes/functions.php'); // Adjust the path if necessary
...
<body>
    <section id="header">
        <a href=""><img src="logo.png" alt="">
            ...
            <div id="mobile">
                <a href="profile.php"><i class="far fa-user"></i>
                </a>
